package top.incoding.cloud.result;


import top.incoding.cloud.constant.ResultCode;
...
public class R<T> implements Serializable {
    ...
    public static R ok(String message) {
        ...
        r.setResult(1);
        r.setCode(ResultCode.SUCCESS.getCode());
        r.setMessage((message==null || message.isEmpty())? ResultCode.SUCCESS.getMessage():message);
        return r;
    }
